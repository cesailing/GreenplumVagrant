...
Vagrant.configure(2) do |config|
  ...
  config.vm.define "sdw1" do |sdw1|
    ...
    sdw1.vm.customize ["modifyvm", :id, "--memory", "4096"]
    sdw1.vm.customize ["modifyvm", :id,  "--cpus",  "2"]
  ...
  config.vm.define "sdw2" do |sdw2|
    ...
    sdw2.vm.customize ["modifyvm", :id, "--memory", "4096"]
    sdw2.vm.customize ["modifyvm", :id,  "--cpus",  "2"]
  ...
  config.vm.define "sdw3" do |sdw3|
    ...
    sdw3.vm.customize ["modifyvm", :id, "--memory", "4096"]
    sdw3.vm.customize ["modifyvm", :id,  "--cpus",  "2"]
  ...
  config.vm.define "mdw" do |mdw|
    ...
    mdw.vm.customize ["modifyvm", :id, "--memory", "2048"]
    mdw.vm.customize ["modifyvm", :id,  "--cpus",  "2"]
